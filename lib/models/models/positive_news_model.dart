...
class PositiveNewsModel {
  ...
  factory PositiveNewsModel.fromRawJson(String str) => PositiveNewsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PositiveNewsModel.fromJson(Map<String, dynamic> json) => PositiveNewsModel(
