...
class NeutralNewsModel {
  ...
  factory NeutralNewsModel.fromRawJson(String str) => NeutralNewsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory NeutralNewsModel.fromJson(Map<String, dynamic> json) => NeutralNewsModel(
