...
class SpotSignalModel {
  ...
  factory SpotSignalModel.fromRawJson(String str) => SpotSignalModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SpotSignalModel.fromJson(Map<String, dynamic> json) => SpotSignalModel(
    id: json["_id"],
    pair: json["pair"],
