...
class FutureSignalModel {
  ...
  factory FutureSignalModel.fromRawJson(String str) => FutureSignalModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FutureSignalModel.fromJson(Map<String, dynamic> json) => FutureSignalModel(
    id: json["_id"],
    pair: json["pair"],
